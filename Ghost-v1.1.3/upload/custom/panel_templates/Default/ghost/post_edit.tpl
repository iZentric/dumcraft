            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <h5 style="display:inline">{$EDIT_POST}</h5>
                            ...
                            <form action="" method="post">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="InputPostName" placeholder="{$GHOST_POST_NAME}"
                                        name="ghost_post_name" class="form-control" value="{$GHOST_POST_NAME_VALUE}">
                                </div>
                                <div class="form-group">
                                    <label for="InputPostDate">{$GHOST_POST_DATE}</label>
                                    <br /><input type="datetime-local" id="InputPostDate" name="ghost_post_date" value="{$GHOST_POST_DATE_VALUE}">
                                </div>
                                <div class="form-group">
                                    <label for="InputPostImage">{$GHOST_POST_IMAGE}</label>
                                    <input type="text" id="InputPostImage" placeholder="{$GHOST_POST_IMAGE}"
                                        name="ghost_post_image" class="form-control" value="{$GHOST_POST_IMAGE_VALUE}">
                                </div>
                                <div class="form-group">
                                    <label for="InputPostRules">{$GHOST_POST_CONTENT}</label>
                                    <textarea name="ghost_post_content" rows="3" id="InputPostContent"
                                        class="form-control" placeholder="{$GHOST_POST_CONTENT}">{$GHOST_POST_CONTENT_VALUE}</textarea>
                                </div>
                                <div class="form-group">
